...
<label for="small-input" class="block my-4 text-sm font-medium text-blackdark:text-gray-300">ID del producto</label>
...
?>
    <label for="countries" class="block my-4 text-sm font-medium text-black">Seleccionar categoria</label>
    <select id="countries" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white ">
<?php 
...
if (isset($_POST['send'])) {
    ...
    $query1 = "INSERT INTO productos (nombre, cantidad, descripcion, precio) VALUES ('$producto', $cantidad, '$descripcion', $precio)";
